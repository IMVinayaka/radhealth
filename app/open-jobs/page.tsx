              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Allied Healthcare Others">
                      Allied Healthcare Others
                    </option>
                  ...
                  <div className="col-span-1  space-y-4 lg:max-h-[calc(100vh-20rem)] overflow-y-auto pr-2">
                    {filteredJobs.length > 0 ? (
                      filteredJobs.map((job) => (
                        <motion.div
                          key={job.JobID}
                          className={`bg-white m-2 rounded-xl shadow-md  border border-gray-100 hover:shadow-lg transition-shadow duration-300 cursor-pointer ${
                          ...
                          <div className="py-3  px-3">
                            <div className="flex justify-between items-start overflow-hidden truncate ellipsis">
                              <div className="flex items-center justify-start gap-1">
                                <h3
                                  title={job.JobTitle}
                                  className="text-md max-w-max ellipsis truncate font-[500] text-gray-900 "
                                >
                                  {job.JobTitle},
                                </h3>
                            ...
                            <h4
                              title={job.location}
                              className="text-primary ellipsis truncate text-sm font-[400] "
                            >
                              {job.location}
                            </h4>
                          </div>
                    ...
                    {selectedJob && selectedJob.JobID !== 0 ? (
                      <div className="sticky top-6 bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
                        <div className="bg-gradient-to-r from-primary to-primary-dark p-6 text-white flex justify-between items-center">
                          <div>
                            ...
                            <p className="text-primary-extraLight">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <XCircleIcon
                              className="h-7 w-7 cursor-pointer text-primary hover:text-gray-700 transition"
                      ...
                      <div className="bg-white rounded-xl shadow-md p-8 text-center h-full flex flex-col items-center justify-center">
                        ...
                        <div className="flex flex-col items-center gap-2 py-3 mt-16">
                          <p>No current openings match your profile?</p>
                          <p>
                            We still want to hear from you. Please upload your
                            resume and we will consider your application for
